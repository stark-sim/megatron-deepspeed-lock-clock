...
LOG="$BASE/.context/dual8_tp4pp1dp2_static990_20260403.log"
HOSTFILE="/tmp/hostfile_dual8_tp4pp1dp2_static990_20260403"
...
RUN_ID="dual8_tp4pp1dp2_static990_$(date +%Y%m%d_%H%M%S)_DGX2-1"
...
deepspeed \
    ...
    --experiment-name "dual8_tp4pp1dp2_static990" \
    --experiment-root-dir "$BASE/experiments" \
    --bf16 2>&1 | tee -a "$LOG_DIR/$RUN_ID.log"

echo "[collect] 990 MHz completed: $RUN_ID"
