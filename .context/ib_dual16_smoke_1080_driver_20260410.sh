...
RUN_ID="ib_dual16_tp4pp1dp4_smoke_1080_${TS}_DGX2-1"
...
export EXPERIMENT_NAME="ib_dual16_tp4pp1dp4_smoke_1080_20260410"
...
timeout 1800 ./scripts/run_experiment.sh
rc=$?
echo "EXIT_CODE=${rc}"
