...
- generated_at: `2026-04-09T11:16:18Z`
...
- alpha_dp_s_per_byte: `7.321889e-10`
- alpha_tp_s_per_byte: `0.000000e+00`

## Target Points
- `1005` MHz: time observed/predicted=`217.963/227.286` s, time APE=`0.0428`, step observed/predicted=`10.898/11.364` s
- `1200` MHz: time observed/predicted=`202.778/217.120` s, time APE=`0.0707`, step observed/predicted=`10.139/10.856` s
- `1395` MHz: time observed/predicted=`217.560/208.560` s, time APE=`0.0414`, step observed/predicted=`10.878/10.428` s
