...
export TORCH_EXTENSIONS_DIR="/dev/shm/megatron_common_qwen3b_20260419/torch_extensions_v100"
...
run_one() {
    ...
    run_id="${BATCH_ID}_${label}_${run_ts}_v100x16-1"
