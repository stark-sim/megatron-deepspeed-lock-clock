...
RUN_ID="ib_dual8_tp4pp1dp2_formal_1155_retry_${TS}_DGX2-1"
...
export EXPERIMENT_NAME="ib_dual8_tp4pp1dp2_formal_1155_retry_20260410"
export STATIC_CLOCK_MHZ="1155"
export TP="4"
export PP="1"
export NNODES="2"
export HOSTFILE
...
timeout 3600 ./scripts/run_experiment.sh
rc=$?
echo "EXIT_CODE=${rc}"
