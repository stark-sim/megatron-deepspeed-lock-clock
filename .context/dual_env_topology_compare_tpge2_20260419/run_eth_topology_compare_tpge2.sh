...
BATCH_ID="eth_topology_compare_tpge2_kv4_20260419"
...
export TORCH_EXTENSIONS_DIR="/dev/shm/megatron_tpge2_compare_20260419/torch_extensions_tp4bit"
...
run_one() {
    ...
    run_id="${BATCH_ID}_${topo_name}_${run_ts}_sd-1"
