...
def _v100_dual_node_calibration_points() -> List[CrossNodeCalibrationPoint]:
    ...
    return [
        ...
        # Real TP=2,PP=2,DP=4 single-node static frequency measurements (2026-03-23)
        # Single-node: 16 GPUs on sd@v100x16-1 with locked GPU frequencies
        CrossNodeCalibrationPoint(
            ...
            single_node_time_s=420.4,  # measured: 20 * 21.02s
        ...
        CrossNodeCalibrationPoint(
            ...
            workload=WorkloadFeatures(global_batch_size=16, tensor_model_parallel_size=2, pipeline_model_parallel_size=2, data_parallel_size=4, **common),
            single_node_time_s=417.5,  # measured: 20 * 20.87s
        ...
        CrossNodeCalibrationPoint(
            ...
            workload=WorkloadFeatures(global_batch_size=16, tensor_model_parallel_size=2, pipeline_model_parallel_size=2, data_parallel_size=4, **common),
            single_node_time_s=415.1,  # measured: 20 * 20.75s
