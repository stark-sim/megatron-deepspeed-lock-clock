...
- [ ] Choose the next topology from feasible, proxy-distinct 16-GPU decompositions; avoid known dead ends like invalid `TP=8, DP=2` and low-value pairings that collapse under the current analytic proxy (for example `TP=4, PP=2, DP=2`).
