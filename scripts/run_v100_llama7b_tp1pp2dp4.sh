...
export EXPERIMENT_NAME="${EXPERIMENT_NAME:-ib_llama7b_tp1pp2dp4_smoke5_finetune_nosave}"
...
export HOSTFILE="${HOSTFILE:-/tmp/hostfile_llama7b_tp1pp2dp4_v100}"
...
# NOTE: Must be a TP1PP2 checkpoint. Run convert_llama7b_hf_to_megatron_v100.sh 1 2 first.
export LOAD_CHECKPOINT_PATH="${LOAD_CHECKPOINT_PATH:-${BASE_PATH}/checkpoints/llama7b_hf2megads_tp1pp2_latest}"
