...
export EXPERIMENT_NAME="${EXPERIMENT_NAME:-ib_llama7b_tp1pp4dp2_smoke5_finetune_nosave}"
...
export MASTER_PORT="${MASTER_PORT:-32131}"
export HOSTFILE="${HOSTFILE:-/tmp/hostfile_llama7b_tp1pp4dp2_v100}"
...
# NOTE: Must be a TP1PP4 checkpoint. Run convert_llama7b_hf_to_megatron_v100.sh 1 4 first.
export LOAD_CHECKPOINT_PATH="${LOAD_CHECKPOINT_PATH:-${BASE_PATH}/checkpoints/llama7b_hf2megads_tp1pp4_latest}"
