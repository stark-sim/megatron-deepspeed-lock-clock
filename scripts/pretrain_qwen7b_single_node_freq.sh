...
DS_CONFIG=${BASE_PATH}/scripts/ds_config_7b.json
DATASET="${BASE_PATH}/data/chinese_wiki_megatron_text_document"
CHECKPOINT_PATH=${BASE_PATH}/checkpoints/qwen7b_single
...
/home/sd/.local/bin/torchrun \
    ...
    --deepspeed \
    2>&1 | tee ${BASE_PATH}/logs/qwen7b_freq_$(date +%Y%m%d_%H%M%S).log
