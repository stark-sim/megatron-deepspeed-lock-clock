...
export EXPERIMENT_NAME="${EXPERIMENT_NAME:-v100_llama7b_tp2pp2dp2_baseline_formal20_finetune_nosave}"
...
export MASTER_PORT="${MASTER_PORT:-31231}"
export HOSTFILE="${HOSTFILE:-/tmp/hostfile_v100_llama7b_tp2pp2dp2}"
