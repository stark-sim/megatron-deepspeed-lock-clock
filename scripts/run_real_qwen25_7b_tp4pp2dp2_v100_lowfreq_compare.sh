...
LAUNCH_SCRIPT="${BASE_PATH}/scripts/run_real_qwen25_7b_tp4pp2dp2_v100.sh"
...
MASTER_PORT_BASE="${MASTER_PORT_BASE:-31401}"
...
run_one() {
    ...
    experiment_name="ib_real_qwen25_7b_tp4pp2dp2_static${clock}_${RUN_TAG}"
    MASTER_PORT="${port}" \
    EXPERIMENT_NAME="${experiment_name}" \
