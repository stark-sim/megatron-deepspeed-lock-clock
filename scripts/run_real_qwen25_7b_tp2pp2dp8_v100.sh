...
export EXPERIMENT_NAME="${EXPERIMENT_NAME:-ib_real_qwen25_7b_tp2pp2dp8_full32_smoke5_finetune_nosave}"
...
export HOSTFILE="${HOSTFILE:-/tmp/hostfile_real_qwen25_7b_tp2pp2dp8_v100}"
...
export LOAD_CHECKPOINT_PATH="${LOAD_CHECKPOINT_PATH:-${BASE_PATH}/checkpoints/qwen25_7b_instruct_hf2megads_tp2pp2_20260508_002412}"
