...
BASE_PORT=31931
RUN_TAG="retest_formal${STEPS}_finetune_nosave"

echo "========================================"
echo "Qwen2.5-7B TP4PP2DP2 RETEST Sweep (High Freq)"
...
EXPERIMENT_NAME="ib_real_qwen25_7b_tp4pp2dp2_baseline_${RUN_TAG}" \
...
for freq in ${FREQS}; do
    ...
    EXPERIMENT_NAME="ib_real_qwen25_7b_tp4pp2dp2_static${freq}_${RUN_TAG}" \
