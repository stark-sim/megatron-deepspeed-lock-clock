...
MASTER_PORT_BASE="${MASTER_PORT_BASE:-31041}"
...
sleep 10
run_one static "1500" "$((MASTER_PORT_BASE + 10))"
#sleep 10
#run_one static "1252" "$((MASTER_PORT_BASE + 20))"
#sleep 10
#run_one static "1155" "$((MASTER_PORT_BASE + 30))"
