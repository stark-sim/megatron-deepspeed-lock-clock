...
MASTER_PORT_BASE="${MASTER_PORT_BASE:-31301}"
RUN_TAG="${RUN_TAG:-retest_formal20_finetune_nosave}"
...
sleep 10
run_one static "1530" "$((MASTER_PORT_BASE + 10))"
sleep 10
run_one static "1455" "$((MASTER_PORT_BASE + 20))"
sleep 10
run_one static "1350" "$((MASTER_PORT_BASE + 30))"
sleep 10
run_one static "1260" "$((MASTER_PORT_BASE + 40))"
