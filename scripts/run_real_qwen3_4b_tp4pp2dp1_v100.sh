...
export EXPERIMENT_NAME="${EXPERIMENT_NAME:-ib_real_qwen3_4b_tp4pp2dp1_smoke5_finetune_nosave}"
...
export MASTER_PORT="${MASTER_PORT:-31631}"
export HOSTFILE="${HOSTFILE:-/tmp/hostfile_real_qwen3_4b_tp4pp2dp1_v100}"
...
# NOTE: Update this path after TP4PP2 conversion completes
export LOAD_CHECKPOINT_PATH="${LOAD_CHECKPOINT_PATH:-${BASE_PATH}/checkpoints/qwen3_4b_hf2megads_tp4pp2_latest}"
