#!/bin/bash
# 预测试 V4 - 使用 pdsh 方式 (和之前成功的实验一致)

set -euo pipefail

BASE_PATH="/home/sd/Megatron-DeepSpeed"

echo "=== 预测试：双节点拓扑验证 (pdsh 方式) ==="
...
/usr/bin/python3 -m deepspeed \
    ...
    --deepspeed --bf16 2>&1 | tee /home/sd/Megatron-DeepSpeed/logs/pretest_v4_1.log | tail -30
