...
export EXPERIMENT_NAME="${EXPERIMENT_NAME:-v100_tp1pp4dp4_7blike_baseline20}"
...
export MASTER_PORT="${MASTER_PORT:-31131}"
export HOSTFILE="${HOSTFILE:-/tmp/hostfile_v100_tp1pp4dp4_7blike}"
