...
export EXPERIMENT_NAME="${EXPERIMENT_NAME:-ib_real_qwen3_4b_tp2pp2dp2_smoke5_finetune_nosave}"
...
export HOSTFILE="${HOSTFILE:-/tmp/hostfile_real_qwen3_4b_tp2pp2dp2_v100}"
...
# Use Qwen3 HF model dir for tokenizer; fallback to qwen25_tokenizer_flat
...
# NOTE: Update this path after conversion completes
export LOAD_CHECKPOINT_PATH="${LOAD_CHECKPOINT_PATH:-${BASE_PATH}/checkpoints/qwen3_4b_hf2megads_tp2pp2_latest}"
