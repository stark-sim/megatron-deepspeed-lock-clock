...
LAUNCH_SCRIPT="${BASE_PATH}/scripts/run_v100_qwen7b_tp1pp2dp8_16card.sh"
...
MASTER_PORT_BASE="${MASTER_PORT_BASE:-31631}"
EXPERIMENT_PREFIX="${EXPERIMENT_PREFIX:-v100_qwen7b_16card}"
# =============================
