...
export EXPERIMENT_NAME="${EXPERIMENT_NAME:-ib_real_qwen25_7b_tp4pp2dp4_full32_smoke5_finetune_nosave}"
...
export HOSTFILE="${HOSTFILE:-/tmp/hostfile_real_qwen25_7b_tp4pp2dp4_v100}"
